...
interface DashboardData {
  employee: {
    ...
    salary: number | null;
    reportingHead: { id: string; name: string; designation: string | null } | null;
  } | null;
  ceo: { id: string; name: string; designation: string | null } | null;
...
export default async function EmployeeDashboard() {
  const data = await apiJson<DashboardData>('/api/dashboard/employee');
  const { employee, ceo, activeAttendance, stats } = data;
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{stats.leavesLeft} days</p>
              </div>
            </div>
          </CardContent>
        </Card>
